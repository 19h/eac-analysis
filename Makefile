...
$(HANDLERS_PSEUDOCODE_C): vm_handler_pseudocode_dump.py $(PRIMARY_DIR)/vm_handler_semantics.tsv $(PRIMARY_DIR)/vm_handler_table.tsv $(STATIC_ONLY_HANDLER_QUEUE_TSV) $(STATIC_ONLY_TIER0_MODELS_TSV) $(STATIC_ONLY_TIER1_MODELS_TSV) $(STATIC_ONLY_TIER2_SPLIT_TSV) $(STATIC_ONLY_TIER3_SHARED_TSV)
	python3 vm_handler_pseudocode_dump.py --all > $@

$(HANDLERS_HOT_PSEUDOCODE_C): vm_handler_pseudocode_dump.py $(PRIMARY_DIR)/vm_handler_semantics.tsv $(PRIMARY_DIR)/vm_handler_table.tsv $(STATIC_ONLY_HANDLER_QUEUE_TSV) $(STATIC_ONLY_TIER0_MODELS_TSV) $(STATIC_ONLY_TIER1_MODELS_TSV) $(STATIC_ONLY_TIER2_SPLIT_TSV) $(STATIC_ONLY_TIER3_SHARED_TSV)
...
$(ALL_EVIDENCE_BUNDLE_C): vm_recovered_source_all_evidence_bundle.py $(SOURCE_BUNDLE_C) $(NATIVE_RET_PATCH_TARGETS_C) $(NATIVE_RET_PATCH_EPILOGUES_RETDEC_C) $(NATIVE_RET_PATCH_SOURCE278_RETDEC_C) $(RET_PATCH_FOLLOWUPS_C) $(RET_PATCH_FOLLOWUP_RETDEC_C) $(NATIVE_OBFUSCATED_ISLANDS_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_DYNAMIC_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_SLOT_PROOF_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_STACK_SOURCE_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_RBX_PROVENANCE_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_MODEL_C) $(NATIVE_OBFUSCATED_CONTROL_MODEL_C) $(NATIVE_RET_PATCH_HIDDEN_BRIDGE_C) $(NATIVE_HANDLER_ENVIRONMENT_COVERAGE_C) $(STATIC_ONLY_HANDLER_QUEUE_C) $(STATIC_ONLY_TIER0_MODELS_C) $(STATIC_ONLY_TIER1_MODELS_C) 1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER2_SPLIT_C) 1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER3_SHARED_C) 1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001TARGET_ONLY_HANDLER_RETDEC_C) $(UNOBSERVED_HANDLER_RETDEC_CS) $(WEAK_HANDLER_RETDEC_C) $(VALIDATED_HANDLER_RETDEC_CS) $(UNRESOLVED_FAMILY_C)
...
pseudocode-syntax-check: $(PSEUDOCODE_TOP_C) $(PROGRAM_PSEUDOCODE_TOP_C) $(PROGRAM_PSEUDOCODE_FULL_C) $(HANDLERS_PSEUDOCODE_C) $(PATH_HANDLERS_PSEUDOCODE_C) $(SOURCE_BUNDLE_C) $(ALL_EVIDENCE_BUNDLE_C) $(NATIVE_RET_PATCH_TARGETS_C) $(NATIVE_RET_PATCH_EPILOGUES_RETDEC_C) $(NATIVE_RET_PATCH_SOURCE278_RETDEC_C) $(RET_PATCH_FOLLOWUPS_C) $(RET_PATCH_FOLLOWUP_RETDEC_C) $(NATIVE_OBFUSCATED_ISLANDS_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_DYNAMIC_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_SLOT_PROOF_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_STACK_SOURCE_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_RBX_PROVENANCE_C) $(NATIVE_OBFUSCATED_SECOND_STAGE_MODEL_C) $(NATIVE_OBFUSCATED_CONTROL_MODEL_C) $(NATIVE_RET_PATCH_HIDDEN_BRIDGE_C) $(NATIVE_HANDLER_ENVIRONMENT_COVERAGE_C) $(STATIC_ONLY_HANDLER_QUEUE_C) $(STATIC_ONLY_TIER0_MODELS_C) $(STATIC_ONLY_TIER1_MODELS_C) 1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER2_SPLIT_C) 1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER3_SHARED_C) 1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001TARGET_ONLY_HANDLER_RETDEC_C) $(UNOBSERVED_HANDLER_RETDEC_CS) $(WEAK_HANDLER_RETDEC_C) $(VALIDATED_HANDLER_RETDEC_CS) $(UNRESOLVED_FAMILY_C)
	...
	$(CC) -std=c11 -fsyntax-only -Wall -Wextra -Wno-unused-variable -Wno-unused-function -Wno-unused-parameter -Wno-uninitialized -Wno-parentheses -Wno-sign-compare -Wno-pointer-to-int-cast -Wno-type-limits -Wno-tautological-constant-out-of-range-compare -Wno-incompatible-pointer-types -Wno-return-stack-address -Wno-deprecated-non-prototype dumps/vmtail-wide-1m-w16/vm_recovered_source_all_evidence_bundle.c
	...
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001CC) -std=c11 -fsyntax-only -Wall -Wextra -Wno-unused-function dumps/vmtail-wide-1m-w16/vm_static_only_tier2_split_models.c
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001CC) -std=c11 -fsyntax-only -Wall -Wextra -Wno-unused-function dumps/vmtail-wide-1m-w16/vm_static_only_tier3_shared_models.c
...
C_RECONSTRUCTION_MANIFEST_INPUTS := \
	...
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER2_SPLIT_MD) \
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER3_SHARED_C) \
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER3_SHARED_TSV) \
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001STATIC_ONLY_TIER3_SHARED_MD) \
	1000 4 24 27 30 46 100 114 127 130 983 984 993 995 1000 1001TARGET_ONLY_HANDLER_RETDEC_C) \

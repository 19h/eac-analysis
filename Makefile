...
pseudocode-full: bytecode-basic-blocks synthetic-tail-lift
...
c-reconstruction-manifest: pseudocode-syntax-check pseudocode-object-check pseudocode-link-check coverage-audit synthetic-successor-gaps

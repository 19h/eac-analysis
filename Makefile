...
RECONSTRUCTION_AUTOPILOT_ARGS ?= --rounds 24 --jobs 8 --probe-jobs 8 --chunk-bytes 0x200 --max-gap-chunks 5 --max-candidates 192 --max-accepted 8 --timeout 30 --checkpoint-frequency 8 --final-checkpoint --salvage-failed-batches

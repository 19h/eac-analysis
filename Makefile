...
NATIVE_GAP_RETDEC_BATCH_CS := $(NATIVE_GAP_RETDEC_BATCH00_C) $(NATIVE_GAP_RETDEC_BATCH01_C) $(NATIVE_GAP_RETDEC_BATCH02_C) $(NATIVE_GAP_RETDEC_BATCH03_C) $(NATIVE_GAP_RETDEC_BATCH04_C)

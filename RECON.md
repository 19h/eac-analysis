...
- `dumps/vmtail-wide-1m-w16/vm_unobserved_handlers_retdec_batch00.c`: targeted RetDec C artifact for the 24 smallest unobserved VM handler native ranges; RetDec splits them into 40 native C functions plus 1 external helper prototype.

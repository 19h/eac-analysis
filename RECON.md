...
- `dumps/vmtail-wide-1m-w16/vm_native_retdec_gap_queue.c`, `.tsv`, and `.md`: ranked native function backlog for semantic C recovery. It records 2176 queued `.text` functions, 620977 function-boundary uncovered bytes, and a tier mix of 1848 small, 247 medium, 77 large, and 4 huge/noisy targets; the C sidecar keeps all 2176 rows in the all-evidence file.

...
- `dumps/vmtail-wide-1m-w16/vm_native_retdec_gap_queue.c`, `.tsv`, and `.md`: ranked native function backlog for semantic C recovery. It records 2974 queued `.text` functions, 818462 function-boundary uncovered bytes, and a tier mix of 2646 small, 247 medium, 77 large, and 4 huge/noisy targets; the C sidecar keeps all 2974 rows in the all-evidence file.

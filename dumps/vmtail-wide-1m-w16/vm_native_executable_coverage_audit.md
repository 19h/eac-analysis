...
- recovered executable bytes: 1304294
- uncovered executable bytes: 4346746
- recovered range rows: 11520
- uncovered gaps: 2421
...
| `.text` | `0x20c00-0x583650` | 5646928 | 1304294 | 4342634 | 23.09% | 11520 |
...
| section | range | bytes |
| --- | --- | ---: |
| `.text` | `0xe879c-0xfeebc` | 91936 |
| `.text` | `0x310ebb-0x3275b6` | 91899 |
| `.text` | `0x144f13-0x15b5b2` | 91807 |
| `.text` | `0x21b066-0x231586` | 91424 |
| `.text` | `0x18bc85-0x1a1fa3` | 90910 |
| `.text` | `0x165caa-0x17bf1f` | 90741 |
| `.text` | `0x2f121e-0x307093` | 89717 |

...
- recovered executable bytes: 5638940
- uncovered executable bytes: 12100
- recovered range rows: 87326
- uncovered gaps: 691
...
| `.text` | `0x20c00-0x583650` | 5646928 | 5634828 | 12100 | 99.78% | 87066 |
...
| `.text` | `0x4ddf09-0x4ddf29` | 32 |
| `.text` | `0x4ddfb9-0x4ddfd9` | 32 |
| `.text` | `0x4ddff9-0x4de019` | 32 |
| `.text` | `0x4de069-0x4de089` | 32 |
| `.text` | `0x4de1c9-0x4de1e9` | 32 |

...
- recovered executable bytes: 632773
- uncovered executable bytes: 5018267
- recovered range rows: 5852
- uncovered gaps: 1565
...
| `.text` | `0x20c00-0x583650` | 5646928 | 632773 | 5014155 | 11.20% | 5852 |
...
| section | range | bytes |
| --- | --- | ---: |
| `.text` | `0x4519e3-0x487214` | 219185 |
| `.text` | `0x13010e-0x15b5b2` | 177316 |
| `.text` | `0x2e301e-0x30d540` | 173346 |

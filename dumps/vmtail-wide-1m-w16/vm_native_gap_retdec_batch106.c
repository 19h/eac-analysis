 ...
 *
 * Ranges:
 *   0x2a04ec-0x2a0519 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4afafa-0x4afb27 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4b0bb0-0x4b0bdd rank=- name=- kind=- bytes=- uncovered=-
 *   0x508250-0x50827d rank=- name=- kind=- bytes=- uncovered=-
 *   0x5082b0-0x5082dd rank=- name=- kind=- bytes=- uncovered=-
 *   0x518f10-0x518f3d rank=- name=- kind=- bytes=- uncovered=-
 *   0x518f70-0x518f9d rank=- name=- kind=- bytes=- uncovered=-
 *   0x52e2a0-0x52e2cd rank=- name=- kind=- bytes=- uncovered=-
 *   0x52e300-0x52e32d rank=- name=- kind=- bytes=- uncovered=-
 *   0x552350-0x55237d rank=- name=- kind=- bytes=- uncovered=-
 *   0x563360-0x56338d rank=- name=- kind=- bytes=- uncovered=-
 *   0x563580-0x5635ad rank=- name=- kind=- bytes=- uncovered=-
 *   0x57a090-0x57a0bd rank=- name=- kind=- bytes=- uncovered=-
 *   0x21b76-0x21ba2 rank=- name=- kind=- bytes=- uncovered=-
 *   0x44e68-0x44e94 rank=- name=- kind=- bytes=- uncovered=-
 *   0x54834-0x54860 rank=- name=- kind=- bytes=- uncovered=-
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t unknown_1a5f8c06();
int64_t unknown_ffffffffc9a6c1f7();

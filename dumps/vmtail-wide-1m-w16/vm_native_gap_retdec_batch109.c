 ...
 *
 * Ranges:
 *   0x5045a0-0x5045ca rank=- name=- kind=- bytes=- uncovered=-
 *   0x5631b0-0x5631da rank=- name=- kind=- bytes=- uncovered=-
 *   0x5631f0-0x56321a rank=- name=- kind=- bytes=- uncovered=-
 *   0x5690a0-0x5690ca rank=- name=- kind=- bytes=- uncovered=-
 *   0x5690f0-0x56911a rank=- name=- kind=- bytes=- uncovered=-
 *   0x56b9a0-0x56b9ca rank=- name=- kind=- bytes=- uncovered=-
 *   0x56b9f0-0x56ba1a rank=- name=- kind=- bytes=- uncovered=-
 *   0x27df1-0x27e1a rank=- name=- kind=- bytes=- uncovered=-
 *   0x2a711-0x2a73a rank=- name=- kind=- bytes=- uncovered=-
 *   0x36966-0x3698f rank=- name=- kind=- bytes=- uncovered=-
 *   0x4afd4-0x4affd rank=- name=- kind=- bytes=- uncovered=-
 *   0x4dacc-0x4daf5 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507a2-0x507cb rank=- name=- kind=- bytes=- uncovered=-
 *   0x507cc-0x507f5 rank=- name=- kind=- bytes=- uncovered=-
 *   0x60eae-0x60f42 rank=- name=- kind=- bytes=- uncovered=-
 *   0x6872c-0x68755 rank=- name=- kind=- bytes=- uncovered=-
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>

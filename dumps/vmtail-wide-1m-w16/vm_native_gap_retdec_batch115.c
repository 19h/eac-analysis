 ...
 *
 * Ranges:
 *   0x2a237-0x2a25b rank=- name=- kind=- bytes=- uncovered=-
 *   0x2b776-0x2b79a rank=- name=- kind=- bytes=- uncovered=-
 *   0x36126-0x3614a rank=- name=- kind=- bytes=- uncovered=-
 *   0x462e6-0x4630a rank=- name=- kind=- bytes=- uncovered=-
 *   0x46d51-0x46d75 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4d974-0x4d998 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4eaea-0x4eb0e rank=- name=- kind=- bytes=- uncovered=-
 *   0x61f0e-0x61f32 rank=- name=- kind=- bytes=- uncovered=-
 *   0x67c72-0x67c96 rank=- name=- kind=- bytes=- uncovered=-
 *   0x6af9a-0x6afbe rank=- name=- kind=- bytes=- uncovered=-
 *   0x1c0b59-0x1c0b7d rank=- name=- kind=- bytes=- uncovered=-
 *   0x3c5b46-0x3c5b6a rank=- name=- kind=- bytes=- uncovered=-
 *   0x48d7c9-0x48d7ed rank=- name=- kind=- bytes=- uncovered=-
 *   0x491e2c-0x491e50 rank=- name=- kind=- bytes=- uncovered=-
 *   0x49efb0-0x49efd4 rank=- name=- kind=- bytes=- uncovered=-
 *   0x49f0e0-0x49f104 rank=- name=- kind=- bytes=- uncovered=-
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t unknown_ffffffffe026915f();

 ...
 *
 * Ranges:
 *   0x4ba580-0x4ba5a3 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4ba6b0-0x4ba6d3 rank=- name=- kind=- bytes=- uncovered=-
 *   0x56d3b0-0x56d3d3 rank=- name=- kind=- bytes=- uncovered=-
 *   0x20dca-0x20dec rank=- name=- kind=- bytes=- uncovered=-
 *   0x372b0-0x372d2 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4ae54-0x4ae76 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4c7c2-0x4c7e4 rank=- name=- kind=- bytes=- uncovered=-
 *   0x61d6e-0x61d90 rank=- name=- kind=- bytes=- uncovered=-
 *   0x28494c-0x28496e rank=- name=- kind=- bytes=- uncovered=-
 *   0x2a468f-0x2a46b1 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4f18e0-0x4f1902 rank=- name=- kind=- bytes=- uncovered=-
 *   0x2b88e-0x2b8af rank=- name=- kind=- bytes=- uncovered=-
 *   0x361a8-0x361c9 rank=- name=- kind=- bytes=- uncovered=-
 *   0x2e117a-0x2e119b rank=- name=- kind=- bytes=- uncovered=-
 *   0x358a24-0x358a45 rank=- name=- kind=- bytes=- uncovered=-
 *   0x4927ac-0x4927cd rank=- name=- kind=- bytes=- uncovered=-
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t unknown_ffffffffb8c4d43e();

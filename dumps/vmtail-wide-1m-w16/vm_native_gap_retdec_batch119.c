 ...
 *
 * Ranges:
 *   0x4fbfc0-0x4fbfe0 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507d10-0x507d30 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507d30-0x507d50 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507d50-0x507d70 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507d70-0x507d90 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507db0-0x507dd0 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507dd0-0x507df0 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507df0-0x507e10 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507e30-0x507e50 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507e50-0x507e70 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507e70-0x507e90 rank=- name=- kind=- bytes=- uncovered=-
 *   0x507e90-0x507eb0 rank=- name=- kind=- bytes=- uncovered=-
 *   0x5083f0-0x508410 rank=- name=- kind=- bytes=- uncovered=-
 *   0x508430-0x508450 rank=- name=- kind=- bytes=- uncovered=-
 *   0x518e00-0x518e20 rank=- name=- kind=- bytes=- uncovered=-
 *   0x518e20-0x518e40 rank=- name=- kind=- bytes=- uncovered=-
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>

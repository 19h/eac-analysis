 ...
 *
 * Ranges:
 *   0x4c6920-0x4c693e rank=- name=- kind=- bytes=- uncovered=-
 *   0x4cb4a0-0x4cb4be rank=- name=- kind=- bytes=- uncovered=-
 *   0x4cccc0-0x4cccde rank=- name=- kind=- bytes=- uncovered=-
 *   0x4cddb0-0x4cddce rank=- name=- kind=- bytes=- uncovered=-
 *   0x4cf0a0-0x4cf0be rank=- name=- kind=- bytes=- uncovered=-
 *   0x4cf9d0-0x4cf9ee rank=- name=- kind=- bytes=- uncovered=-
 *   0x4d0040-0x4d005e rank=- name=- kind=- bytes=- uncovered=-
 *   0x4d1b10-0x4d1b2e rank=- name=- kind=- bytes=- uncovered=-
 *   0x53472-0x5348f rank=- name=- kind=- bytes=- uncovered=-
 *   0x72750-0x7276d rank=- name=- kind=- bytes=- uncovered=-
 *   0x48d8d1-0x48d8ee rank=- name=- kind=- bytes=- uncovered=-
 *   0x48dd5f-0x48dd7c rank=- name=- kind=- bytes=- uncovered=-
 *   0x48e020-0x48e03d rank=- name=- kind=- bytes=- uncovered=-
 *   0x4ac5f0-0x4ac60d rank=- name=- kind=- bytes=- uncovered=-
 *   0x4ac610-0x4ac62d rank=- name=- kind=- bytes=- uncovered=-
 *   0x4b0870-0x4b088d rank=- name=- kind=- bytes=- uncovered=-
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>

 ...
 *
 * Ranges:
 *   0x542290-0x542348 rank=13 name=fcn.00542290 kind=r2_discovered bytes=184 uncovered=184
 *   0x772f8-0x773af rank=14 name=fcn.000772f8 kind=r2_discovered bytes=183 uncovered=183
 *   0x212f0-0x213a6 rank=15 name=entry.init16 kind=native_discovered bytes=182 uncovered=182
 *   0x214f0-0x215a6 rank=16 name=entry.init20 kind=native_discovered bytes=182 uncovered=182
 *   0x4a93a-0x4a9f0 rank=17 name=fcn.0004a93a kind=r2_discovered bytes=182 uncovered=182
 *   0x4cfef0-0x4cffa6 rank=18 name=fcn.004cfef0 kind=r2_discovered bytes=182 uncovered=182
 *   0x551750-0x551806 rank=19 name=fcn.00551750 kind=r2_discovered bytes=182 uncovered=182
 *   0x557210-0x5572c6 rank=20 name=fcn.00557210 kind=r2_discovered bytes=182 uncovered=182
 *   0x5572d0-0x557386 rank=21 name=fcn.005572d0 kind=r2_discovered bytes=182 uncovered=182
 *   0x59a64-0x59b19 rank=22 name=fcn.00059a64 kind=r2_discovered bytes=181 uncovered=181
 *   0x68c64-0x68d19 rank=23 name=fcn.00068c64 kind=r2_discovered bytes=181 uncovered=181
 *   0x4aa470-0x4aa525 rank=24 name=fcn.004aa470 kind=r2_discovered bytes=181 uncovered=181
 *   0x29fa8-0x2a05c rank=25 name=fcn.00029fa8 kind=r2_discovered bytes=180 uncovered=180
 *   0x5dd2a-0x5ddde rank=26 name=fcn.0005dd2a kind=r2_discovered bytes=180 uncovered=180
 *   0x161df6-0x161eaa rank=27 name=fcn.00161df6 kind=r2_discovered bytes=180 uncovered=180
 *   0x498c50-0x498d04 rank=28 name=fcn.00498c50 kind=r2_discovered bytes=180 uncovered=180
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t function_161df6();
int64_t function_1fcc0();
int64_t function_20210();
int64_t function_203b0();
int64_t function_212f0();
int64_t function_214f0();

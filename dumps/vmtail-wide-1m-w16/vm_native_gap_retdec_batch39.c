 ...
 *
 * Ranges:
 *   0x6bf2a-0x6bfdb rank=13 name=fcn.0006bf2a kind=r2_discovered bytes=177 uncovered=177
 *   0x4a0650-0x4a0701 rank=14 name=fcn.004a0650 kind=r2_discovered bytes=177 uncovered=177
 *   0x54e9d0-0x54ea81 rank=15 name=method.std::__codecvt_utf16_base_char16_t_.virtual_56 kind=native_discovered bytes=177 uncovered=177
 *   0x1cbf51-0x1cc001 rank=16 name=fcn.001cbf51 kind=r2_discovered bytes=176 uncovered=176
 *   0x49a2d0-0x49a380 rank=17 name=fcn.0049a2d0 kind=r2_discovered bytes=176 uncovered=176
 *   0x4221c-0x422cb rank=18 name=fcn.0004221c kind=r2_discovered bytes=175 uncovered=175
 *   0x4bee5-0x4bf94 rank=19 name=fcn.0004bee5 kind=r2_discovered bytes=175 uncovered=175
 *   0x6b28c-0x6b33b rank=20 name=fcn.0006b28c kind=r2_discovered bytes=175 uncovered=175
 *   0x6b33c-0x6b3eb rank=21 name=fcn.0006b33c kind=r2_discovered bytes=175 uncovered=175
 *   0x4b0be0-0x4b0c8f rank=22 name=fcn.004b0be0 kind=r2_discovered bytes=175 uncovered=175
 *   0x4b0fc0-0x4b106f rank=23 name=fcn.004b0fc0 kind=r2_discovered bytes=175 uncovered=175
 *   0x5289c-0x5294a rank=24 name=fcn.0005289c kind=r2_discovered bytes=174 uncovered=174
 *   0x4b8370-0x4b841e rank=25 name=fcn.004b8370 kind=r2_discovered bytes=174 uncovered=174
 *   0x4ba380-0x4ba42e rank=26 name=fcn.004ba380 kind=r2_discovered bytes=174 uncovered=174
 *   0x548e60-0x548f0e rank=27 name=method.std::__iosfail_type_info.virtual_40 kind=native_discovered bytes=174 uncovered=174
 *   0x4482e-0x448db rank=28 name=fcn.0004482e kind=r2_discovered bytes=173 uncovered=173
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t function_548e60();
int64_t function_548ea0();
int64_t function_548ed0();
int64_t function_548f00();
int64_t function_54dd60();
int64_t function_54e5f0();
int64_t function_54e9d0();

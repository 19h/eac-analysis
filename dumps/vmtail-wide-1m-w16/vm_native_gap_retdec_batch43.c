 ...
 *
 * Ranges:
 *   0x5677a0-0x567842 rank=13 name=fcn.005677a0 kind=r2_discovered bytes=162 uncovered=162
 *   0x36990-0x36a31 rank=14 name=fcn.00036990 kind=r2_discovered bytes=161 uncovered=161
 *   0x5f0f4-0x5f195 rank=15 name=fcn.0005f0f4 kind=r2_discovered bytes=161 uncovered=161
 *   0x567d40-0x567de1 rank=16 name=fcn.00567d40 kind=r2_discovered bytes=161 uncovered=161
 *   0x5724e0-0x572581 rank=17 name=fcn.005724e0 kind=r2_discovered bytes=161 uncovered=161
 *   0x3de87-0x3df27 rank=18 name=fcn.0003de87 kind=r2_discovered bytes=160 uncovered=160
 *   0x46d75-0x46e15 rank=19 name=fcn.00046d75 kind=r2_discovered bytes=160 uncovered=160
 *   0x4aec20-0x4aed0d rank=20 name=fcn.004aec20 kind=r2_discovered bytes=237 uncovered=160
 *   0x4bbf40-0x4bbfe0 rank=21 name=fcn.004bbf40 kind=r2_discovered bytes=160 uncovered=160
 *   0x50b730-0x50b7d0 rank=22 name=fcn.0050b730 kind=r2_discovered bytes=160 uncovered=160
 *   0x54c500-0x54c5a0 rank=23 name=fcn.0054c500 kind=r2_discovered bytes=160 uncovered=160
 *   0x54c5e0-0x54c680 rank=24 name=fcn.0054c5e0 kind=r2_discovered bytes=160 uncovered=160
 *   0x54e800-0x54e8a0 rank=25 name=method.std::__codecvt_utf16_base_wchar_t_.virtual_56 kind=native_discovered bytes=160 uncovered=160
 *   0x54faa0-0x54fb40 rank=26 name=method.std::__codecvt_utf16_base_char32_t_.virtual_56 kind=native_discovered bytes=160 uncovered=160
 *   0x555410-0x5554b0 rank=27 name=fcn.00555410 kind=r2_discovered bytes=160 uncovered=160
 *   0x2a5d3-0x2a672 rank=28 name=fcn.0002a5d3 kind=r2_discovered bytes=159 uncovered=159
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t function_54e800();
int64_t function_54faa0();

 ...
 *
 * Ranges:
 *   0x490032-0x4900cf rank=13 name=fcn.00490032 kind=r2_discovered bytes=157 uncovered=157
 *   0x52d890-0x52d92d rank=14 name=fcn.0052d890 kind=r2_discovered bytes=157 uncovered=157
 *   0x52d960-0x52d9fd rank=15 name=fcn.0052d960 kind=r2_discovered bytes=157 uncovered=157
 *   0x253a6-0x25442 rank=16 name=fcn.000253a6 kind=r2_discovered bytes=156 uncovered=156
 *   0x4630a-0x463a6 rank=17 name=fcn.0004630a kind=r2_discovered bytes=156 uncovered=156
 *   0x4e66a-0x4e706 rank=18 name=fcn.0004e66a kind=r2_discovered bytes=156 uncovered=156
 *   0x4b81c0-0x4b825c rank=19 name=fcn.004b81c0 kind=r2_discovered bytes=156 uncovered=156
 *   0x4e9c00-0x4e9c9c rank=20 name=sym.ZydisCalcAbsoluteAddressEx kind=symbol_named bytes=156 uncovered=156
 *   0x549a50-0x549aec rank=21 name=fcn.00549a50 kind=r2_discovered bytes=156 uncovered=156
 *   0x54f550-0x54f5ec rank=22 name=fcn.0054f550 kind=r2_discovered bytes=156 uncovered=156
 *   0x4b71f0-0x4b728b rank=23 name=fcn.004b71f0 kind=r2_discovered bytes=155 uncovered=155
 *   0x582980-0x582a1b rank=24 name=fcn.00582980 kind=r2_discovered bytes=155 uncovered=155
 *   0x29f0e-0x29fa8 rank=25 name=fcn.00029f0e kind=r2_discovered bytes=154 uncovered=154
 *   0x5de9e-0x5df38 rank=26 name=fcn.0005de9e kind=r2_discovered bytes=154 uncovered=154
 *   0x1a1fa3-0x1a203d rank=27 name=fcn.001a1fa3 kind=r2_discovered bytes=154 uncovered=154
 *   0x4b4200-0x4b429a rank=28 name=fcn.004b4200 kind=r2_discovered bytes=154 uncovered=154
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>
...
int64_t function_490032(int64_t result) {
    ...
    gmtime_r((int32_t *)&time_val, (struct tm *)&time2);

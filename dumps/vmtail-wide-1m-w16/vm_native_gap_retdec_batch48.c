 ...
 *
 * Ranges:
 *   0x56b730-0x56b7c3 rank=13 name=method.std::messages_wchar_t_.virtual_16 kind=native_discovered bytes=147 uncovered=147
 *   0x2a421-0x2a4b3 rank=14 name=fcn.0002a421 kind=r2_discovered bytes=146 uncovered=146
 *   0x4eda6-0x4ee38 rank=15 name=fcn.0004eda6 kind=r2_discovered bytes=146 uncovered=146
 *   0x2c7675-0x2c7707 rank=16 name=fcn.002c7675 kind=r2_discovered bytes=146 uncovered=146
 *   0x4b1900-0x4b1992 rank=17 name=fcn.004b1900 kind=r2_discovered bytes=146 uncovered=146
 *   0x4b19a0-0x4b1a32 rank=18 name=fcn.004b19a0 kind=r2_discovered bytes=146 uncovered=146
 *   0x4b7290-0x4b7322 rank=19 name=fcn.004b7290 kind=r2_discovered bytes=146 uncovered=146
 *   0x4caa90-0x4cab22 rank=20 name=fcn.004caa90 kind=r2_discovered bytes=146 uncovered=146
 *   0x517140-0x5171d2 rank=21 name=method.std::num_get_wchar_t__std::istreambuf_iterator_wchar_t__std::char_traits_wchar_t_____.virtual_96 kind=native_discovered bytes=146 uncovered=146
 *   0x54de20-0x54deb2 rank=22 name=fcn.0054de20 kind=r2_discovered bytes=146 uncovered=146
 *   0x54f4b0-0x54f542 rank=23 name=method.std::__codecvt_utf8_base_char16_t_.virtual_32 kind=native_discovered bytes=146 uncovered=146
 *   0x5601d0-0x560262 rank=24 name=method.std::num_get_char__std::istreambuf_iterator_char__std::char_traits_char_____.virtual_96 kind=native_discovered bytes=146 uncovered=146
 *   0x27998-0x27a29 rank=25 name=fcn.00027998 kind=r2_discovered bytes=145 uncovered=145
 *   0x53334-0x533c5 rank=26 name=fcn.00053334 kind=r2_discovered bytes=145 uncovered=145
 *   0x54fa00-0x54fa91 rank=27 name=method.std::__codecvt_utf8_utf16_base_char16_t_.virtual_16 kind=native_discovered bytes=145 uncovered=145
 *   0x5514e0-0x551571 rank=28 name=fcn.005514e0 kind=r2_discovered bytes=145 uncovered=145
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>

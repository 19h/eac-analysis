 ...
 *
 * Ranges:
 *   0x506f00-0x506f8e rank=13 name=method.std::basic_ofstream_wchar_t__std::char_traits_wchar_t___.virtual_8 kind=native_discovered bytes=142 uncovered=142
 *   0x507020-0x5070ae rank=14 name=method.std::basic_ifstream_wchar_t__std::char_traits_wchar_t___.virtual_0 kind=native_discovered bytes=142 uncovered=142
 *   0x3dcac-0x3dd39 rank=15 name=fcn.0003dcac kind=r2_discovered bytes=141 uncovered=141
 *   0x71c60-0x71ced rank=16 name=fcn.00071c60 kind=r2_discovered bytes=141 uncovered=141
 *   0x4978a0-0x49792d rank=17 name=fcn.004978a0 kind=r2_discovered bytes=141 uncovered=141
 *   0x4d8f60-0x4d8fed rank=18 name=fcn.004d8f60 kind=r2_discovered bytes=141 uncovered=141
 *   0x54e6e0-0x54e76d rank=19 name=method.std::__codecvt_utf16_base_char32_t_.virtual_32 kind=native_discovered bytes=141 uncovered=141
 *   0x54e770-0x54e7fd rank=20 name=method.std::__codecvt_utf16_base_wchar_t_.virtual_32 kind=native_discovered bytes=141 uncovered=141
 *   0x44ae0-0x44b6c rank=21 name=fcn.00044ae0 kind=r2_discovered bytes=140 uncovered=140
 *   0x54e640-0x54e6cc rank=22 name=fcn.0054e640 kind=r2_discovered bytes=140 uncovered=140
 *   0x550870-0x5508fc rank=23 name=fcn.00550870 kind=r2_discovered bytes=140 uncovered=140
 *   0x2263e-0x226c9 rank=24 name=fcn.0002263e kind=r2_discovered bytes=139 uncovered=139
 *   0x4fbc4-0x4fc4f rank=25 name=fcn.0004fbc4 kind=r2_discovered bytes=139 uncovered=139
 *   0x5c3b0-0x5c4c0 rank=26 name=fcn.0005c3b0 kind=r2_discovered bytes=272 uncovered=139
 *   0x686a0-0x6872b rank=27 name=fcn.000686a0 kind=r2_discovered bytes=139 uncovered=139
 *   0x126851-0x1268dc rank=28 name=fcn.00126851 kind=r2_discovered bytes=139 uncovered=139
 */
#include <stdbool.h>
#include <stdio.h>
#include <stdint.h>

...
static void second_stage_dynamic_cad88(VMState *vm, const VMSecondStageDynamicDispatch *edge) {
    ...
    /* table_base_mix=0xc3718:4; slot_base_check_mix=slot_minus_idx_matches_dispatch_table:4 */
...
static void second_stage_dynamic_c559d(VMState *vm, const VMSecondStageDynamicDispatch *edge) {
    ...
    /* table_base_mix=0xc3718:8; slot_base_check_mix=slot_minus_idx_matches_dispatch_table:8 */

...
| `0x11db16` | `needs_more_evidence` | `0x11dc27` | 210 | `covered_synthetic_fallthrough` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |
| `0x11dc37` | `needs_more_evidence` | `0x3603af` | 86 | `decoded_control` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |
| `0x11dd03` | `needs_more_evidence` | `0x11de14` | 210 | `covered_synthetic_fallthrough` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |
| `0x11de27` | `needs_more_evidence` | `0x11de9f` | 171 | `decoded_control` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |

- Concrete successor reductions emitted: `15` / `15` cases
- Cases with complete stateful formula inputs: `11` / `15` cases

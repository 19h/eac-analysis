...
static const VMProgramAtlasMBAReducedCase vm_program_atlas_014_mba_reduced_cases[] = {
    {0x1209d2u, 0x120af4u, 264, "needs_more_evidence", "covered_synthetic_fallthrough", "next = 264@0xaf4cf:1, ip += +0x4; dispatch_model=static_100", 0x14cu, 0x1c01u, 0xd71cu, 0xcc5fu, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
    {0x120b02u, 0x120d67u, 356, "needs_more_evidence", "covered_synthetic_fallthrough", "next = 356@0xc291a:1, ip += +0x4; dispatch_model=static_100", 0x102u, 0x4601u, 0xc246u, 0x7607u, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
    {0x120d75u, 0x1210d6u, 165, "needs_more_evidence", "decoded_control", "next = table[165], ip += 0x238", 0x10cu, 0x4a01u, 0x1c4au, 0x63e6u, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
};

...
static const VMProgramAtlasMBAReducedCase vm_program_atlas_023_mba_reduced_cases[] = {
    {0x177353u, 0x1774b8u, 216, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 216@0xa4a61:1, ip += +0x4; dispatch_model=static_100", 0x15eu, 0xe101u, 0x5ee1u, 0x3806u, 0x40000100u, 0x40120140u, ""},
    {0x1774c6u, 0x17776fu, 356, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 356@0xc291a:1, ip += +0x4; dispatch_model=static_100", 0xcbu, 0x9f00u, 0x919fu, 0x7635u, 0x792c86d8u, 0x880eb39fu, ""},
    {0x17777du, 0x177930u, 334, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 334@0xbdd18:1, ip += +0x5; dispatch_model=static_100", 0x1cu, 0x6000u, 0x860u, 0x6910u, 0x4030040u, 0x4030040u, ""},
    {0x177940u, 0x177aebu, 264, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 264@0xaf4cf:1, ip += +0x4; dispatch_model=static_100", 0x7430u, 0x9474u, 0x394u, 0x5fecu, 0xe10003fcu, 0x14df945bu, ""},
    {0x177af9u, 0x179f43u, 354, "ready_for_mba_reduction", "decoded_control", "next = table[354], ip += 0x22c1", 0x12u, 0x6000u, 0x860u, 0xa93au, 0xeb1cdffau, 0x55aaf870u, ""},
};

...
static const VMProgramAtlasMBAReducedCase vm_program_atlas_063_mba_reduced_cases[] = {
    {0x36ecdcu, 0x36eefeu, 165, "ready_for_mba_reduction", "fallthrough", "next = 165@0x9a24c:1, ip += +0x2; dispatch_model=static_100; state=state_add_const", 0x1e8u, 0xa501u, 0xa5u, 0xbdu, 0x95626080u, 0xe37ca780u, ""},
    {0x36eefeu, 0x36ef46u, 171, "ready_for_mba_reduction", "decoded_control", "next = table[171], ip += 0x30", 0x12u, 0xc800u, 0xac8u, 0x303au, 0xe73b5c3au, 0x40500044u, ""},
    {0x36ef2cu, 0x36eefeu, 165, "ready_for_mba_reduction", "decoded_control", "next = table[165], ip -= 0x40", 0x9a17u, 0x69au, 0x3706u, 0x4dfdu, 0x5632a04du, 0xe1ddcb7cu, ""},
    {0x36ef46u, 0x36f14au, 165, "ready_for_mba_reduction", "fallthrough", "next = 165@0x9a24c:1, ip += +0x2; dispatch_model=static_100; state=state_mixed", 0xfeu, 0xe800u, 0x1e8u, 0x4742u, 0xe50599f5u, 0x942ab014u, ""},
    {0x36f14au, 0x36f6afu, 165, "ready_for_mba_reduction", "decoded_control", "next = table[165], ip += 0x288", 0x102u, 0x3701u, 0xb637u, 0x75d6u, 0x20450380u, 0x8e8d264u, ""},
    {0x36f438u, 0x36f14au, 165, "ready_for_mba_reduction", "decoded_control", "next = table[165], ip -= 0x55d", 0x1e8u, 0x2e01u, 0x8a2eu, 0x8f99u, 0x8410188u, 0xcb0d4e12u, ""},
    {0x36f6afu, 0x36f820u, 165, "ready_for_mba_reduction", "fallthrough", "next = 165@0x9a24c:1, ip += +0x2; dispatch_model=static_100", 0x15bu, 0x8101u, 0x3981u, 0x931u, 0x813bbb95u, 0x9156e97u, ""},
    {0x36f820u, 0x36faf6u, 171, "ready_for_mba_reduction", "decoded_control", "next = table[171], ip += 0x28b", 0xc7u, 0x6f00u, 0x456fu, 0x343au, 0xbd39f3b5u, 0xf3eeef8du, ""},
    {0x36f87cu, 0x36f820u, 165, "ready_for_mba_reduction", "decoded_control", "next = table[165], ip -= 0x2ce", 0x4f46u, 0x7d4fu, 0x247du, 0x7ba9u, 0xf6f61332u, 0x73e5c887u, ""},
    {0x36faf6u, 0x36fca8u, 264, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 264@0xaf4cf:1, ip += +0x4; dispatch_model=static_100", 0xbdu, 0x6800u, 0x68u, 0xefdcu, 0x79b325e5u, 0x3d4c18b5u, ""},
    {0x36fcb6u, 0x36fed4u, 356, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 356@0xc291a:1, ip += +0x4; dispatch_model=static_100", 0x72u, 0x7300u, 0x6373u, 0xac8cu, 0x3f06a0dau, 0x6da79e65u, ""},
    {0x36fee2u, 0x370127u, 69, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 69@0x85f24:1, ip += +0x4; dispatch_model=static_100", 0xc7u, 0x9f00u, 0x4a9fu, 0x433au, 0x914b5bb7u, 0x821e3ce8u, ""},
    {0x370138u, 0x370249u, 246, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 246@0xab427:1, ip += +0x5; dispatch_model=static_100", 0x2bu, 0x2d00u, 0x7e2du, 0x99u, 0xe37b0020u, 0xbed1ad51u, ""},
    {0x370256u, 0x370258u, 340, "ready_for_mba_reduction", "fallthrough", "next = 340@0xbf435:25, ip += +0x2; dispatch_model=static_100; state=state_const_post", 0x154u, 0xfc01u, 0xdfcu, 0x68u, 0x22450180u, 0x4628cc64u, ""},
    {0x370258u, 0x3703d8u, 311, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 311@0xb86f8:26, ip += +0x4; dispatch_model=static_100", 0xdfcu, 0x680du, 0x68u, 0x546au, 0x0u, 0x0u, ""},
    {0x3703e6u, 0x370770u, 354, "ready_for_mba_reduction", "decoded_control", "next = table[354], ip += 0x279", 0x14du, 0xfb01u, 0xe6fbu, 0x99u, 0xd144dfafu, 0x27023d6u, ""},
    ...
    {0x370a91u, 0x370cb0u, 356, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 356@0xc291a:25, ip += +0x4; dispatch_model=static_100", 0xf4du, 0xef0fu, 0x82efu, 0xc0afu, 0x4a066bd3u, 0xf59bd3cau, ""},
    {0x370cbeu, 0x370f0au, 264, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 264@0xaf4cf:25, ip += +0x4; dispatch_model=static_100", 0x42u, 0x7900u, 0x9379u, 0x793au, 0x3fca8af8u, 0x512e3387u, ""},
    {0x370f18u, 0x37142cu, 354, "ready_for_mba_reduction", "fallthrough", "next = 354@0xc2241:25, ip += +0x2; dispatch_model=static_100", 0xc7u, 0xd700u, 0x4ed7u, 0x533au, 0x4048004u, 0x4048004u, ""},
    {0x37142cu, 0x37171cu, 354, "ready_for_mba_reduction", "decoded_control", "next = table[354], ip += 0x2a5", 0xb9u, 0xe300u, 0xa9e3u, 0x953au, 0x8a73150cu, 0x40000c25u, ""},
    {0x371488u, 0x3716c7u, 354, "ready_for_mba_reduction", "decoded_control", "next = table[354], ip += 0x139", 0x1e8u, 0x1u, 0x2a00u, 0x361du, 0x34b2a1aeu, 0x63180044u, ""},
};

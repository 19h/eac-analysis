...
static const VMProgramAtlasMBAReducedCase vm_program_atlas_064_mba_reduced_cases[] = {
    {0x3716c7u, 0x37142cu, 354, "needs_more_evidence", "decoded_control", "next = table[354], ip -= 0x2e8", 0x10cu, 0x1901u, 0x1c19u, 0x6cbeu, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
    {0x37171cu, 0x3717c4u, 165, "needs_more_evidence", "decoded_control", "next = table[165], ip += 0x78", 0xfdu, 0x1e00u, 0xbe1eu, 0x0u, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
};

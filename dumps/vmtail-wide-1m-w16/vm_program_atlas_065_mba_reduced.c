...
static const VMProgramAtlasMBAReducedCase vm_program_atlas_065_mba_reduced_cases[] = {
    {0x3717c4u, 0x3718ffu, 311, "needs_more_evidence", "covered_synthetic_fallthrough", "next = 311@0xb86f8:25, ip += +0x4; dispatch_model=static_100", 0x40u, 0xd500u, 0xabd5u, 0x91u, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
    {0x37190du, 0x371a20u, 316, "needs_more_evidence", "covered_synthetic_fallthrough", "next = 316@0xb987b:25, ip += +0x5; dispatch_model=static_100", 0x72u, 0xcb00u, 0x64cbu, 0xac8cu, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},
    {0x371a30u, 0x370256u, 171, "needs_more_evidence", "decoded_control", "next = table[171], ip -= 0x17ed", 0x9c64u, 0xae9cu, 0x65aeu, 0x3498u, 0x0u, 0x0u, "state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte"},

...
static const VMProgramAtlasMBAReducedCase vm_program_atlas_065_mba_reduced_cases[] = {
    ...
    {0x371a63u, 0x371b85u, 95, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 95@0x8c41c:1, ip += +0x4; dispatch_model=static_100", 0x14cu, 0x1c01u, 0xd71cu, 0xcc47u, 0x3a8343ccu, 0x11c11b45u, ""},
    {0x371b93u, 0x371e16u, 311, "ready_for_mba_reduction", "covered_synthetic_fallthrough", "next = 311@0xb86f8:1, ip += +0x4; dispatch_model=static_100", 0x10cu, 0x4a01u, 0x1c4au, 0x6276u, 0x68fb09e1u, 0x87c92330u, ""},
    {0x371e24u, 0x36504cu, 310, "ready_for_mba_reduction", "decoded_control", "sampled operand footprint 0x6; observed target table[310], delta -0xcf8b", 0x2bu, 0xfd00u, 0x7efdu, 0x99u, 0xe60cd495u, 0x8240381u, ""},
};

...
| --- | --- | --- | ---: | --- | --- |
| `0x3717c4` | `needs_more_evidence` | `0x3718ff` | 311 | `covered_synthetic_fallthrough` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |
| `0x37190d` | `needs_more_evidence` | `0x371a20` | 316 | `covered_synthetic_fallthrough` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |
| `0x371a30` | `needs_more_evidence` | `0x370256` | 171 | `decoded_control` | `state_trace_pre_state,state_trace_pre_flags,state_trace_pre_byte` |
...
- Cases with complete stateful formula inputs: `0` / `6` cases

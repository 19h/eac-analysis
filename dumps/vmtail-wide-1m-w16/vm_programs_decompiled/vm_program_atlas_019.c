...
/* VM program atlas 19: 0x122a46..0x122e3c */

static void vmdec_p019_bb_0088(VMState *vm, uint64_t vm_ip);
static void vmdec_p019_bb_0089(VMState *vm, uint64_t vm_ip);
...
static void vmdec_p019_bb_0088(VMState *vm, uint64_t vm_ip) {
    ...
    next_entry = 278;
    vm_ip += 0x4;
    /* terminal CFG edge: covered_synthetic_fallthrough, target_vm_ip=0x122c7b, coverage=frontier_span_of_14:1 */
    vm_unresolved_synthetic_tail(vm, 0x122c7b);
    (void)state0;
    (void)flags0;
    (void)byte0;
    (void)next_entry;
...
static void vmdec_p019_bb_0089(VMState *vm, uint64_t vm_ip) {
    ...
    next_entry = 299;
    vm_ip += 0x4;
    /* terminal CFG edge: covered_synthetic_fallthrough, target_vm_ip=0x122e3c, coverage=target_footprint_of_6:1 */
    vm_unresolved_synthetic_tail(vm, 0x122e3c);
    (void)state0;
    (void)flags0;
    (void)byte0;
    (void)next_entry;
...
void vm_program_atlas_019_decompiled(VMState *vm, uint64_t vm_ip) {
    switch (vm_ip) {
    case 0x122a46: vmdec_p019_bb_0088(vm, vm_ip); return;
    case 0x122c89: vmdec_p019_bb_0089(vm, vm_ip); return;

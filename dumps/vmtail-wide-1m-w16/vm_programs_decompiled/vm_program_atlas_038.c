...
/* VM program atlas 38: 0x2bf97c..0x2bf9cc */

static void vmdec_p038_bb_0210(VMState *vm, uint64_t vm_ip);
...
static void vmdec_p038_bb_0210(VMState *vm, uint64_t vm_ip) {
    ...
    int next_entry = -1;
    /* VM block 210: 0x2bf97c..0x2bf9b7; rows=14, terminal=long_branch_forward */
    /* 0x2bf97c..0x2bf97e: exact_instruction, entry=165, bytes=0201; next = 258@0xadf2c:1, ip += +0x2; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    vm->state = 0x0u;
    next_entry = 258;
    vm_ip += 0x2;
    /* 0x2bf97e..0x2bf982: exact_instruction, entry=258, bytes=d4c22176; next = 185@0x9d964:1, ip += +0x4; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 185;
    vm_ip += 0x4;
    /* 0x2bf982..0x2bf985: exact_instruction, entry=185, bytes=eb8150; next = 157@0x98a9a:1, ip += +0x3; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 157;
    vm_ip += 0x3;
    /* 0x2bf985..0x2bf989: exact_instruction, entry=157, bytes=4be7b300; next = 124@0x91e81:1, ip += +0x4; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 124;
    vm_ip += 0x4;
    /* 0x2bf989..0x2bf98f: exact_instruction, entry=124, bytes=b18600512fc0; next = 49@0x82820:1, ip += +0x6; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 49;
    vm_ip += 0x6;
    /* 0x2bf98f..0x2bf994: exact_instruction, entry=49, bytes=00f3d53d01; next = 144@0x95887:1, ip += +0x5; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 144;
    vm_ip += 0x5;
    /* 0x2bf994..0x2bf996: exact_instruction, entry=144, bytes=d79b; next = 165@0x9a24c:1, ip += +0x2; dispatch_model=static_100; state=state_mixed; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 165;
    vm_ip += 0x2;
    /* 0x2bf996..0x2bf998: exact_instruction, entry=165, bytes=4201; next = 322@0xbb3c9:1, ip += +0x2; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    vm->state = 0x0u;
    next_entry = 322;
    vm_ip += 0x2;
    /* 0x2bf998..0x2bf99c: exact_instruction, entry=322, bytes=b3007796; next = 157@0x98a9a:1, ip += +0x4; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 157;
    vm_ip += 0x4;
    /* 0x2bf99c..0x2bf9a0: exact_instruction, entry=157, bytes=038db300; next = 347@0xc088d:1, ip += +0x4; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    vm->state = vm->state ^ 0x2f4dfd84u + U16(vm->ip + 0x2u) | 0x1f5cd114u - vm->flags + 0x3f0d8c6au + 0x2832271cu ^ 0x520e3305u & 0x7edaa354u ^ 0x68e1604du ^ 0x3d2638afu & vm->state ^ 0x2f4dfd84u + U16(vm->ip + 0x2u) ^ U16(vm->ip + 0x0u) + vm->state ^ 0x2f4dfd84u + U16(vm->ip + 0x2u) | 0x1f5cd114u - vm->flags + 0x3f0d8c6au + 0x2832271cu ^ 0x520e3305u & 0x7edaa354u ^ 0x68e1604du ^ 0x3d2638afu & vm->state ^ 0x2f4dfd84u + U16(vm->ip + 0x2u) ^ 0x17d39c9fu;
    next_entry = 347;
    vm_ip += 0x4;
    /* 0x2bf9a0..0x2bf9a4: exact_instruction, entry=347, bytes=7b867717; next = 199@0xa0631:1, ip += +0x4; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    ...
    next_entry = 199;
    vm_ip += 0x4;
    /* 0x2bf9a4..0x2bf9a7: exact_instruction, entry=199, bytes=12eb5d; next = 242@0xaa87d:1, ip += +0x3; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    vm->state = vm->state + U8(vm->ip + 0x2u) + vm->flags ^ 0x7353b039u - 0x24d1328au ^ 0x7e708197u & 0x20d5418u + vm->flags ^ 0x7353b039u - 0x24d1328au;
    next_entry = 242;
    vm_ip += 0x3;
    /* 0x2bf9a7..0x2bf9ac: exact_instruction, entry=242, bytes=3d01136a87; next = 316@0xb987b:1, ip += +0x5; dispatch_model=static_100; validation=state_static=100.0%;dispatch_static=100.0%;ip_static=100.0% */
    vm->state = vm->state | U16(vm->ip + 0x3u) - vm->state ^ 0x5c05e9b5u;
    next_entry = 316;
    vm_ip += 0x5;
    /* 0x2bf9ac..0x2bfe6f: long_branch_forward, entry=316, bytes=62010000c30400003d0122; next = table[354], ip += 0x4c3; validation=file_backed_operand;source_state=transition_model */
    /* state preserved: sampled_backedge */
    next_entry = (int)U32(vm->ip + 0x0);
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
    /* terminal CFG edge: decoded_control, target_vm_ip=0x2bfe6f, coverage=- */
    vm_unresolved_synthetic_tail(vm, 0x2bfe6f);
    (void)state0;
    (void)flags0;
    (void)byte0;
    (void)next_entry;
...
void vm_program_atlas_038_decompiled(VMState *vm, uint64_t vm_ip) {
    switch (vm_ip) {
    case 0x2bf97c: vmdec_p038_bb_0210(vm, vm_ip); return;

...
/* VM program atlas 001: 0xd3fac..0xd4581 */

void vm_program_atlas_001_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0xd3facu: {
    ...
    next_entry = 321;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0xd420b, folded=0xd421c, entry=321, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 321@0xbb1dd:1, ip += +0x4; dispatch_model=static_100; state=state_add_const" */
        next_entry = 321;
        vm_ip = UINT64_C(0xd421c);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 80;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0xd43cf, folded=0xd43e0, entry=80, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 80@0x88a58:1, ip += +0x4; dispatch_model=static_100; state=state_add_const" */
        next_entry = 80;
        vm_ip = UINT64_C(0xd43e0);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0xd476e, folded=-, entry=354, edge="decoded_control", mode=external_or_program_exit; "next = table[354], ip += 0x20d" */
        next_entry = 354;
        vm_program_external_edge(vm, UINT64_C(0xd476e), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;
...
enum { VM_PROGRAM_ATLAS_001_STRING_REF_COUNT = 0 };

...
/* VM program atlas 016: 0x121b31..0x12201d */

void vm_program_atlas_016_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0x121b31u: {
    ...
    next_entry = 95;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x121c83, folded=0x121c91, entry=95, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 95@0x8c41c:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 95;
        vm_ip = UINT64_C(0x121c91);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 278;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x121ec6, folded=0x121ed4, entry=278, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 278@0xb2342:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 278;
        vm_ip = UINT64_C(0x121ed4);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0x122074, folded=-, entry=354, edge="decoded_control", mode=external_or_program_exit; "next = table[354], ip += 0x77" */
        next_entry = 354;
        vm_program_external_edge(vm, UINT64_C(0x122074), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;
...
enum { VM_PROGRAM_ATLAS_016_STRING_REF_COUNT = 0 };

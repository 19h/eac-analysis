...
/* VM program atlas 018: 0x122344..0x1226e6 */

void vm_program_atlas_018_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0x122344u: {
    ...
    next_entry = 264;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x122466, folded=0x122474, entry=264, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 264@0xaf4cf:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 264;
        vm_ip = UINT64_C(0x122474);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 75;
    vm_ip += 0x5;
        /* folded MBA successor: raw=0x122615, folded=0x122626, entry=75, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 75@0x873fc:1, ip += +0x5; dispatch_model=static_100" */
        next_entry = 75;
        vm_ip = UINT64_C(0x122626);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0x122a46, folded=-, entry=171, edge="decoded_control", mode=external_or_program_exit; "next = table[171], ip += 0x380" */
        next_entry = 171;
        vm_program_external_edge(vm, UINT64_C(0x122a46), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;

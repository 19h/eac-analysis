...
/* VM program atlas 022: 0x176883..0x17731c */

void vm_program_atlas_022_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0x176883u: {
    ...
    next_entry = 264;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x176aa5, folded=0x176ab3, entry=264, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 264@0xaf4cf:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 264;
        vm_ip = UINT64_C(0x176ab3);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 95;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x176c87, folded=0x176c95, entry=95, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 95@0x8c41c:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 95;
        vm_ip = UINT64_C(0x176c95);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 216;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x176e97, folded=0x176ea5, entry=216, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 216@0xa4a61:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 216;
        vm_ip = UINT64_C(0x176ea5);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 95;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x1770e9, folded=0x1770f7, entry=95, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 95@0x8c41c:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 95;
        vm_ip = UINT64_C(0x1770f7);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0x177353, folded=-, entry=354, edge="decoded_control", mode=external_or_program_exit; "next = table[354], ip += 0x57" */
        next_entry = 354;
        vm_program_external_edge(vm, UINT64_C(0x177353), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;

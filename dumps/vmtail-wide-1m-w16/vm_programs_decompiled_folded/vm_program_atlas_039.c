...
/* VM program atlas 039: 0x2bfe6f..0x2c05b1 */

void vm_program_atlas_039_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0x2bfe6fu: {
    ...
    next_entry = 216;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x2bff90, folded=0x2bff9e, entry=216, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 216@0xa4a61:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 216;
        vm_ip = UINT64_C(0x2bff9e);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 264;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x2c0230, folded=0x2c023e, entry=264, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 264@0xaf4cf:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 264;
        vm_ip = UINT64_C(0x2c023e);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 356;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x2c045a, folded=0x2c0468, entry=356, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 356@0xc291a:1, ip += +0x4; dispatch_model=static_100" */
        next_entry = 356;
        vm_ip = UINT64_C(0x2c0468);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0x2c1156, folded=-, entry=171, edge="decoded_control", mode=external_or_program_exit; "next = table[171], ip += 0xbc5" */
        next_entry = 171;
        vm_program_external_edge(vm, UINT64_C(0x2c1156), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;

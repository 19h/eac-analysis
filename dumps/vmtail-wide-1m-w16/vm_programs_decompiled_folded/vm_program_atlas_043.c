...
/* VM program atlas 043: 0x31df8f..0x31e862 */

void vm_program_atlas_043_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0x31df8fu: {
    ...
    next_entry = 42;
    vm_ip += 0x169eb;
        /* folded MBA successor: raw=0x334a3d, folded=-, entry=42, edge="decoded_control", mode=external_or_program_exit; "sampled operand footprint 0xa; observed target table[42], delta +0x169eb" */
        next_entry = 42;
        vm_program_external_edge(vm, UINT64_C(0x334a3d), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;
    ...
    next_entry = 145;
    vm_ip += 0x5;
        /* folded MBA successor: raw=0x31e171, folded=0x31e182, entry=145, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 145@0x95b5c:1, ip += +0x5; dispatch_model=static_100; state=state_add_const" */
        next_entry = 145;
        vm_ip = UINT64_C(0x31e182);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 216;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x31e23f, folded=0x31e24d, entry=216, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 216@0xa4a61:1, ip += +0x4; dispatch_model=static_100; state=state_add_const" */
        next_entry = 216;
        vm_ip = UINT64_C(0x31e24d);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 316;
    vm_ip += 0x5;
        /* folded MBA successor: raw=0x31e35e, folded=0x31e36f, entry=316, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 316@0xb987b:1, ip += +0x5; dispatch_model=static_100; state=state_add_const" */
        next_entry = 316;
        vm_ip = UINT64_C(0x31e36f);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 356;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x31e42c, folded=0x31e43a, entry=356, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 356@0xc291a:1, ip += +0x4; dispatch_model=static_100; state=state_add_const" */
        next_entry = 356;
        vm_ip = UINT64_C(0x31e43a);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 75;
    vm_ip += 0x5;
        /* folded MBA successor: raw=0x31e54b, folded=0x31e55c, entry=75, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 75@0x873fc:1, ip += +0x5; dispatch_model=static_100; state=state_add_const" */
        next_entry = 75;
        vm_ip = UINT64_C(0x31e55c);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 42;
    vm_ip += 0x1d02e;
        /* folded MBA successor: raw=0x33b647, folded=-, entry=42, edge="decoded_control", mode=external_or_program_exit; "sampled operand footprint 0xa; observed target table[42], delta +0x1d02e" */
        next_entry = 42;
        vm_program_external_edge(vm, UINT64_C(0x33b647), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;
    ...
    next_entry = 246;
    vm_ip += 0x5;
        /* folded MBA successor: raw=0x31e738, folded=0x31e749, entry=246, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 246@0xab427:1, ip += +0x5; dispatch_model=static_100; state=state_add_const" */
        next_entry = 246;
        vm_ip = UINT64_C(0x31e749);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0x31e77f, folded=0x31e77f, entry=354, edge="decoded_control", mode=direct_block; "next = table[354], ip += 0x22" */
        next_entry = 354;
        vm_ip = UINT64_C(0x31e77f);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = (int)U32(vm->ip + 0x0);
    vm_ip += signed_vm_delta_u32(U32(vm->ip + 0x4));
        /* folded MBA successor: raw=0x31ea5c, folded=-, entry=354, edge="decoded_control", mode=external_or_program_exit; "next = table[354], ip += 0x21a" */
        next_entry = 354;
        vm_program_external_edge(vm, UINT64_C(0x31ea5c), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;

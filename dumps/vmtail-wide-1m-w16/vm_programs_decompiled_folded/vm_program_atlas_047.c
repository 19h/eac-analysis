...
/* VM program atlas 047: 0x333882..0x333bc9 */

void vm_program_atlas_047_decompiled_folded(VMState *vm, uint64_t vm_ip) {
    while (1) {
        switch (vm_ip) {
    case 0x333882u: {
    ...
    next_entry = 216;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x333a08, folded=0x333a16, entry=216, edge="covered_synthetic_fallthrough", mode=hidden_span_fold; "next = 216@0xa4a61:1, ip += +0x4; dispatch_model=static_100; state=state_add_const" */
        next_entry = 216;
        vm_ip = UINT64_C(0x333a16);
        (void)state0;
        (void)flags0;
        (void)byte0;
        (void)next_entry;
    ...
    next_entry = 195;
    vm_ip += 0x4;
        /* folded MBA successor: raw=0x333bc9, folded=-, entry=195, edge="covered_synthetic_fallthrough", mode=external_or_program_exit; "next = 195@0x9fb50:1, ip += +0x4; dispatch_model=static_100; state=state_add_const" */
        next_entry = 195;
        vm_program_external_edge(vm, UINT64_C(0x333bc9), next_entry);
        (void)state0;
        (void)flags0;
        (void)byte0;
        return;
...
enum { VM_PROGRAM_ATLAS_047_STRING_REF_COUNT = 0 };

...
enum { VM_PROGRAM_ATLAS_038_OP_COUNT = (int)(sizeof(vm_program_atlas_038_ops) / sizeof(vm_program_atlas_038_ops[0])) };
...
enum { VM_PROGRAM_ATLAS_038_EDGE_COUNT = (int)(sizeof(vm_program_atlas_038_edges) / sizeof(vm_program_atlas_038_edges[0])) };

static const VMReadableStringRef vm_program_atlas_038_strings[] = {
};
enum { VM_PROGRAM_ATLAS_038_STRING_REF_COUNT = (int)(sizeof(vm_program_atlas_038_strings) / sizeof(vm_program_atlas_038_strings[0])) };

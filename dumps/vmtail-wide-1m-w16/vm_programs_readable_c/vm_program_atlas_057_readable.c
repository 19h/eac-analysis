...
enum { VM_PROGRAM_ATLAS_057_OP_COUNT = (int)(sizeof(vm_program_atlas_057_ops) / sizeof(vm_program_atlas_057_ops[0])) };
...
enum { VM_PROGRAM_ATLAS_057_EDGE_COUNT = (int)(sizeof(vm_program_atlas_057_edges) / sizeof(vm_program_atlas_057_edges[0])) };

static const VMReadableStringRef vm_program_atlas_057_strings[] = {
};
enum { VM_PROGRAM_ATLAS_057_STRING_REF_COUNT = (int)(sizeof(vm_program_atlas_057_strings) / sizeof(vm_program_atlas_057_strings[0])) };

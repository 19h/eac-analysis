...
static const VMReadableOp vm_program_atlas_038_ops[] = {
    ...
    {0x2bf9acu, 0x2bfe6fu, 316u, 354u, "vmop_316_minus0x3c4_sampled_backedge_slot_unknown", "62010000c30400003d0122", "long_or_backedge_control", "state_reduced_exact_observed_dispatch_table", "vm_state = Z3-proved simplified expression; formula=state0", "next_entry = exact observed target-by-bytecode table; rows=13; byte_patterns=13; targets=354:5,165:4,171:4; formula_status=not_recovered", "ip -= 0x3c4 (backedge)", "354@0xc2241", "", "", "slot_unknown_formula_not_recovered_exact_table_only"},
};

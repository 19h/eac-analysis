...
def extract_functions(text):
    ...
    functions = re.sub(r"\bmemset\(", "memset2(", functions)
    functions = re.sub(
...
def normalize_pointer_local_assignments(functions):
    ...
    for index, match in enumerate(matches):
        ...
        for pointer_local in sorted(set(re.findall(r"\b(?:[A-Za-z_]\w*\s+)*[A-Za-z_]\w*\s*\*\s*(v\d+)\s*;", body))):
...
def main():
    ...
    print("typedef struct { uint8_t bytes[108]; } int864_t;")
    print("typedef struct { uint8_t bytes[32]; } int256_t;")
    print("typedef int64_t int224_t;")
    ...
    print("struct __dirstream;")
    print("struct dirent;")
    print("struct pollfd;")
    print("struct sockaddr;")
    print("struct addrinfo;")
    print("struct stat;")
    print("struct stat64;")
    ...
    print("#ifndef EAC_RETDEC_CPUID_REGS_DEFINED")
    print("#define EAC_RETDEC_CPUID_REGS_DEFINED 1")
    print("struct eac_retdec_cpuid_regs { uint32_t e0; uint32_t e1; uint32_t e2; uint32_t e3; };")
    print("#endif")
    ...
    print("uint32_t llvm_bswap_i32(uint32_t value);")
    print("uint64_t llvm_ctlz_i64(uint64_t value, bool is_zero_undef);")
    print("int __popcountdi2(uint64_t value);")
    print("void __asm_int(int32_t interrupt);")
    print("int64_t __asm_int1();")
    print("int64_t __asm_int3();")
    print("int32_t __asm_in(uint16_t port);")
    print("int32_t __asm_in_133(uint16_t port);")
    print("int32_t __asm_in_134(uint16_t port);")
    print("int32_t __asm_in_135(uint16_t port);")
    print("char __asm_in_136(uint16_t port);")
    print("char __asm_in_137(uint16_t port);")
    print("int32_t __asm_in_138(uint16_t port);")
    print("char __asm_insb(uint16_t port);")
    print("int32_t __asm_insd(uint16_t port);")
    print("void __asm_out(uint16_t port, char value);")
    print("void __asm_out_133(uint16_t port, int32_t value);")
    print("void __asm_out_134(uint16_t port, int32_t value);")
    ...
    print("void unknown_11c3039(void);")
    print("int64_t unknown_2a35274a(void);")
    print("int64_t unknown_3dc1cbae(int32_t value);")
    print("int64_t unknown_6847365b(void);")
    print("int64_t unknown_74517502(void);")
    print("int64_t unknown_6ae5a3c4(void);")
    print("int64_t unknown_3d2a4ac0(void);")
    print("int64_t unknown_3f58ba8f(void);")
    print("int64_t unknown_3a9782b0(void);")
    print("int64_t unknown_4a2eb0c7(int64_t value);")
    print("int64_t unknown_4c300d9d(void);")
    print("int64_t unknown_1a5f8c06(void);")
    print("int64_t unknown_1c9eef14(void);")
    print("int64_t unknown_fce9f06(void);")
    print("int64_t unknown_6830301e(void);")
    ...
    print("int64_t unknown_ffffffffa845fcb4(int64_t a1, int64_t a2, int64_t a3);")
    print("int64_t unknown_ffffffffa337f4e6(void);")
    print("int64_t unknown_ffffffffb8c4d43e(void);")
    print("int64_t unknown_ffffffffb1f005c0(int64_t value);")
    print("int64_t unknown_ffffffffc9a6c1f7(void);")
    print("int64_t unknown_ffffffffe026915f(void);")
    print("int64_t unknown_ffffffffffa50add(void);")
    print("int64_t unknown_ffffffff8d401ab3(void);")
    print("int64_t unknown_ffffffff920a593a(int64_t a1, int64_t a2, int64_t a3, int64_t a4);")
    print("int64_t unknown_ffffffffc304842d(int64_t value);")
    print("int64_t unknown_ffffffffc23c8777(int64_t a1, int64_t a2);")
    print("int64_t unknown_ffffffffd64cfc2a(int64_t dst, int64_t src);")
    print("int64_t unknown_ffffffffd296219c(void);")
    print("int64_t unknown_ffffffffe8914fc1(void);")
    print("int64_t unknown_fffffffff537c295(void);")
    print("int64_t unknown_ffffffffb38ec0a9(void);")
    print("int64_t _ITM_RU1(int64_t src);")
    print("int64_t _ITM_RU8(void);")
    ...
    print("int64_t __pseudo_get_significand(float80_t value);")
    print("int64_t __pseudo_get_exponent(float80_t value);")
    ...
    print("uint64_t __asm_rdtsc(void);")
    print("void __stack_chk_fail(void);")
    print("int __cxa_atexit(void (*func)(int64_t *), void *arg, void *dso);")
    print("uint128_t __udivti3(uint128_t a, uint128_t b);")
    print("int64_t _ZN9__gnu_cxxL27__exchange_and_add_dispatchEPii_constprop_31(int64_t value);")
    print("int64_t _ZGTtdlPv(int64_t value);")
    print("int64_t blake3_hasher_init_derive_key_raw(int64_t hasher, int64_t context, int64_t context_len);")
    print("int64_t unknown_166c28d(void);")
    print("int128_t __asm_movsd(int64_t value);")
    print("int128_t __asm_movsd_133(int64_t value);")
    print("int128_t __asm_movd(int32_t value);")
    ...
    print("int128_t __asm_movaps_133(int128_t value);")
    ...
    print("int256_t __asm_vpcmpeqw(int256_t left, int256_t right);")
    print("int256_t __asm_vprord(int256_t value, int count);")
    print("int256_t __asm_vpaddd(int256_t left, int256_t right);")
    print("int256_t __asm_vpxord(int256_t left, int256_t right);")
    ...
    print("int128_t __asm_addsd(int128_t left, int128_t right);")
    print("int128_t __asm_subsd(int128_t left, int128_t right);")
    print("int64_t __asm_cvttsd2si(int128_t value);")
    print("int64_t __asm_vcvttsd2si(int128_t value);")
    print("void __asm_ucomisd(int128_t left, int128_t right);")
    print("void __asm_ucomiss(int128_t left, int64_t right);")
    print("void __asm_ucomiss_134(int128_t left, int128_t right);")
    print("int128_t __asm_movups();")
    print("int128_t __asm_movups_133();")
    print("void __asm_movups_134();")
    ...
    print("struct __locale_struct *__duplocale(struct __locale_struct *locale);")
    ...
    print("size_t __strxfrm_l(char *dest, const char *src, size_t n, struct __locale_struct *locale);")
    print("size_t __wcsxfrm_l(int32_t *dest, const int32_t *src, size_t n, struct __locale_struct *locale);")
    ...
    print("int32_t read(int fd, void *buf, size_t count);")
    ...
    print("int32_t putwc(int32_t wc, struct _IO_FILE *stream);")
    ...
    print("int pthread_mutex_init(void *mutex, void *attr);")
    print("int pthread_mutex_destroy(void *mutex);")
    print("int pthread_mutexattr_init(void *attr);")
    print("int pthread_mutexattr_settype(void *attr, int type);")
    print("int pthread_create(int32_t *thread, const void *attr, int64_t *(*start_routine)(int64_t *), int64_t *arg);")
    print("int pthread_join(int32_t thread, void **retval);")
    print("int pthread_once(int32_t *once_control, ...);")
    print("int pthread_cond_init(void *cond, void *attr);")
    ...
    print("int ftruncate(int fd, int64_t length);")
    ...
    print("struct __dirstream *opendir(const char *name);")
    print("struct dirent *readdir(struct __dirstream *dirp);")
    print("int closedir(struct __dirstream *dirp);")
    print("int64_t blake3_hasher_finalize_seek();")
    ...
    print("int clock_gettime(int clk_id, struct timespec *tp);")
    print("int64_t sysconf(int name);")
    print("int64_t syscall(int64_t number, ...);")
    print("int mprotect(void *addr, size_t len, int prot);")
    print("int memfd_create(void *name, unsigned int flags);")
    print("void *mmap(void *addr, size_t len, int prot, int flags, int fd, int64_t offset);")
    print("int munmap(void *addr, size_t len);")
    print("int __xstat(int ver, const char *path, struct stat *buf);")
    ...
    print("int32_t __strftime_l(char *s, int32_t max, const char *format, struct tm *tm, struct __locale_struct *locale);")
    ...
    print("void *__memcpy_chk(void *dest, const void *src, size_t len, size_t destlen);")
    ...
    print("int64_t _Unwind_GetLanguageSpecificData(int64_t context);")
    print("int64_t _Unwind_GetIPInfo(int64_t context, void *ip_before_insn, int64_t extra);")
    print("int64_t _Unwind_GetRegionStart();")
    print("int64_t _Unwind_RaiseException(int64_t exception);")
    print("void _Unwind_SetGR(int64_t context, int index, int64_t value);")
    print("void _Unwind_SetIP(int64_t context, int64_t value);")

...
def main() -> int:
    ...
    ok &= check(
        ...
        "Dispatch formulas" in md_text and "native-call binding" in md_text and "real-server path coverage" in md_text,
    ...
    print("objective_status=not_complete_dispatch_formula_native_binding_real_server_paths_and_program_intent_open")

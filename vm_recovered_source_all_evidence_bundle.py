...
def main():
    ...
    print("unsigned long strtoul(const char *nptr, char **endptr, int base);")
    print("long strtol(const char *nptr, char **endptr, int base);")
    print("unsigned long long strtoull(const char *nptr, char **endptr, int base);")
    print("char *fgets();")
    print("int feof();")
    print("int ferror(void *stream);")
    print("int puts(const char *s);")
    print("int fputs(const char *s, void *stream);")
    print("int putchar(int c);")
    print("int printf(const char *format, ...);")
    ...
    print("size_t wcstombs(char *dest, const void *src, size_t n);")
    print("size_t mbstowcs(void *dest, const char *src, size_t n);")
